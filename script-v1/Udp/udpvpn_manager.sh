...
uninstall_server() {
    echo -e "\n\e[1;34mUninstalling UDP-VPN server...\e[0m"
    ...
    echo -e "\e[1;32mUDP-VPN server uninstalled successfully.\e[0m"
}

show_banner() {
    echo -e "\e[1;36m---------------------------------------------"
    echo " ဒီ Script မှာဖရီးသုံးဖို့အတွက်မဟုတ်သလို ရောင်းစားခွင့်လည်းမပြုပါ"
    echo " ဖရီးတင်တာဖြစ်ဖြစ် ရောင်းစားတာဖြစ်ဖြစ် တွေရှိပါ တန်းပိတ်မည်"
    echo " Admin ဆက်သွယ်ရန် Telegram:@ovpnth"
    echo -e "---------------------------------------------\e[0m"
}
