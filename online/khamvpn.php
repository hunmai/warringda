...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="index.html">
                <img src="https://my-app-icon.netlify.app/icon_kham.png" alt="Logo" style="width:36px; height:auto;">
                KHAM VPN
            </a>
    ...
    <h3 class="mt-4 text-center">KHAM VPN Server Status</h3>
...
header("Content-Security-Policy: frame-ancestors *;");
        ...
        $servers = [
            '🇹🇭TH-01'=> 'http://shan11.myshan.site:82/server/online',
            '🇹🇭TH-02'=> 'http://shan12.myshan.site:82/server/online',
            '🇹🇭TH-03'=> 'http://shan13.myshan.site:82/server/online',
            '🇹🇭TH-04'=> 'http://shan14.myshan.site:82/server/online',
            '🇹🇭TH-05'=> 'http://shan15.myshan.site:82/server/online',
            '🇹🇭TH-06'=> 'http://shan16.myshan.site:82/server/online',
            '🇹🇭TH-07'=> 'http://shan17.myshan.site:82/server/online',
            '🇹🇭TH-08'=> 'http://shan18.myshan.site:82/server/online',
            '🇹🇭TH-09'=> 'http://shan19.myshan.site:82/server/online',
            '🇹🇭TH-10'=> 'http://shan20.myshan.site:82/server/online',
